...
import { faucetContract, oceanContract, marsContract, stablecoinContract } from '~/consts/contracts';
...
export const Buy = () => {
  ...
  return (
    <div className="flex flex-col w-full gap-4">
      ...
      <div className="flex w-full">
        <Button className="w-full" onClick={handleOpen}>Buy</Button>
      </div>
...
const BuyDEXContent: FC<BuyDEXContentProps> = ({ initialAmount }) => {
  ...
  const handleBuy = useCallback(async () => {
    ...
    try {
      ...
      setSuccess();
      setTimeout(() => {setIdle()}, 3000); // reset status
            ...
            activetabId == "market" ?
              <>
                ...
                <div className="flex flex-col gap-4 mt-auto">
                  <Button disabled={!loggedIn || isLoading || status !== 'idle' } onClick={handleBuy}>
                            ...
                            {otc.map((order, index) => (
                              <tr key={`${order.seller}${index}`}>
                                ...
                                <td className="eq-table-cell justify-center max-w-32">
                                  <div className={`w-full flex justify-start eq-input px-4 py-1.5`}>
                                    <input 
                                      name="text" 
                                      type="number" 
                                      placeholder="0.00" 
