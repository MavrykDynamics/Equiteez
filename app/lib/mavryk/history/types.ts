import { TzktAlias, TzktOperation, TzktTokenTransfer } from 'app/lib/apis/tzkt';
...
type PickedPropsFromTzktOperation = Pick<
  TzktOperation,
  'id' | 'level' | 'hash' | 'block'
>;
...
export interface HistoryItemTokenTransfer
  extends PickedPropsFromTzktTokenTransfer {
